...
describe("notification-service", () => {
    ...
    it.skip('Post notification for na200_usina_ativacao', async () => {
        jest.useFakeTimers({ now: new Date("2025-10-20 00:00:000.00") });
    ...
    it.skip('Post notification for na300_primeiro_boleto', async () => {
        jest.useFakeTimers({ now: new Date("2025-10-20 00:00:000.00") });
    ...
    it.skip('Post notification for na400_envio_de_boleto', async () => {
        jest.useFakeTimers({ now: new Date("2025-10-20 00:00:000.00") });
    ...
    it.skip('Post notification for na500_envio_de_boleto', async () => {
        jest.useFakeTimers({ now: new Date("2025-10-20 00:00:000.00") });
        const invoice: Invoice = {
            invoice_due_date: '2025-10-25 00:00:000.00',
            invoice_emission_date: "2025-10-15 00:00:000.00",
    ...
    it.skip('Post notification for na600_envio_de_boleto', async () => {
        jest.useFakeTimers({ now: new Date("2025-10-20 00:00:000.00") });
    ...
    it.skip('Post notification for na700_envio_de_boleto', async () => {
        jest.useFakeTimers({ now: new Date("2025-10-20 00:00:000.00") });
        const invoice: Invoice = {
            invoice_due_date: '2025-10-25 00:00:000.00',
            invoice_emission_date: "2025-10-15 00:00:000.00",
